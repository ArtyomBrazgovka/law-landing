      ...
      <div className="advantages-container">
        <div className="advantages-title">
          ...
          <h2 className="advantages-subtitle">
            Почему <span className="highlight-text">выбирают</span> нас
          </h2>
        </div>
        <div className="advantages-tiles">
          <Tiles
            ...
            description={
              "Звонки по любым вопросам \nв удобное для вас время. \nМы всегда рядом"
            }
          />
          <Tiles
            source={briefcase}
            title="Высокая экспертность"
            description={
          ...
          <Tiles
            source={chess}
            title="думаем на два шага вперед"
            description={
              "Звонки по любым вопросам \nв удобное для вас время. \nМы всегда рядом"
            }
          />
